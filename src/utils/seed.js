...
console.log("\n--- Seeded accounts (passwords set in src/utils/seed.js, not printed here) ---");
console.log("Admin   : admin@arthub.com");
console.log("Artist  : nira.artist@example.com");
console.log("Artist  : ayan.artist@example.com");
console.log("Buyer   : maya@example.com");
console.log("Buyer   : rafi.collector@example.com");
